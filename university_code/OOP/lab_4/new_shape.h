...
////////////////////////////////////////////////////////////
void New_Shape::setTexture(const Texture* texture, bool resetRect)
{
	if (texture)
	{
...
////////////////////////////////////////////////////////////
const Texture* New_Shape::getTexture() const
{
	return m_texture;
}
...
////////////////////////////////////////////////////////////
void New_Shape::setTextureRect(const IntRect& rect)
{
	m_textureRect = rect;
	updateTexCoords();
}
...
////////////////////////////////////////////////////////////
const IntRect& New_Shape::getTextureRect() const
{
...
////////////////////////////////////////////////////////////
void New_Shape::setFillColor(const Color& color)
{
	m_fillColor = color;
	updateFillColors();
}
...
////////////////////////////////////////////////////////////
const Color& New_Shape::getFillColor() const
{
	return m_fillColor;
}
...
////////////////////////////////////////////////////////////
void New_Shape::setOutlineColor(const Color& color)
{
...
////////////////////////////////////////////////////////////
const Color& New_Shape::getOutlineColor() const
{
...
////////////////////////////////////////////////////////////
void New_Shape::setOutlineThickness(float thickness)
{
...
////////////////////////////////////////////////////////////
float New_Shape::getOutlineThickness() const
{
...
////////////////////////////////////////////////////////////
FloatRect New_Shape::getLocalBounds() const
{
	return m_bounds;
}
...
////////////////////////////////////////////////////////////
FloatRect New_Shape::getGlobalBounds() const
{
...
////////////////////////////////////////////////////////////
void New_Shape::draw(RenderTarget& target, RenderStates states) const
{
...
////////////////////////////////////////////////////////////
void New_Shape::updateFillColors()
{
...
////////////////////////////////////////////////////////////
void New_Shape::updateOutlineColors()
{
